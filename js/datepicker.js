class MeetingScheduler {
  ...
  setupEventListeners() {
      ...
      this.timeSelect.addEventListener("change", (e) => this.selectTime(e.target.value));
...
forms.forEach((form) => {
  ...
  if (!emailInput || !emailContainer) return; // Skip if elements don't exist
  ...
  emailContainer.addEventListener("blur", function (event) {

...
if (isset($_POST['submit'])) {
    ...
    $email_to = "4exult@gmail.com, gchauhan.dm@gmail.com, rakshitkapur.dm@gmail.com";
    // $email_to = "himanshu.lifelinkr@gmail.com, kushk4998@gmail.com";
    $email_subject = "Query from LifeLinkr.in LP (Bottom Form)";
    ...
    $country = $_POST['country']; // requiredai-integrated-software
    $city = $_POST['city']; // required
    $no_of_user = $_POST['no_of_user']; 
    $is_using_software = $_POST['is_using_software']; // required
 ...
 if ($full_url !== 'N/A') {
    ...
    $email_message .= "Email: " . clean_string($company_email) . "\n";
    $email_message .= "Phone: " . clean_string($phone) . "\n";
    $email_message .= "Whatsapp: " . clean_string($whats_num) . "\n";
    $email_message .= "Country: " . clean_string($country) . "\n";
    $email_message .= "City: " . clean_string($city) . "\n";
    $email_message .= "No. of Users: " . clean_string($no_of_user) . "\n";
    $email_message .= "Is Using Software: " . clean_string($is_using_software) . "\n";
